...
@Getter
public class ReportDeleteResponseDto extends ResponseDto {

    private ReportDeleteResponseDto(){
        super();
    }

    public static ResponseEntity<ReportDeleteResponseDto> success(){
        ReportDeleteResponseDto responseBody = new ReportDeleteResponseDto();
