 ...
 **/
@Getter
public class ReportSearchResponseDto extends ResponseDto {
    private ReportSearchResponseDto(){
        super();
    }

    public static ResponseEntity<ReportSearchResponseDto> success(){
        ReportSearchResponseDto responseBody = new ReportSearchResponseDto();
